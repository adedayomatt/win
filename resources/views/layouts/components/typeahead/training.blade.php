<script>
    jQuery(document).ready(function($) {
        ...
        var trainingTHengine = typeaheadEngine("{{route('search.training')}}")

        $('input.training-search').each(function(){
            var input = $(this);
            ...
            { 
                source: trainingTHengine.ttAdapter(),
                ...
                templates: {
                    ...
                    suggestion: function (data) {
                        ...
                        return `<div class="list-group-item">
                                        <a href="{{route('training.index')}}/${data.slug}">
